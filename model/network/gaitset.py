...
class SetNet(nn.Module):
	def __init__(self, hidden_dim, _set_in_channels = 1, _set_channels=[32, 64, 128]):
		...
		# _gl_in_channels = 32
		# _gl_channels = [64, 128]
		self.gl_layer1 = BasicConv2d(_set_channels[0], _set_channels[1], 3, padding=1)
		self.gl_layer2 = BasicConv2d(_set_channels[1], _set_channels[1], 3, padding=1)
		self.gl_layer3 = BasicConv2d(_set_channels[1], _set_channels[2], 3, padding=1)
		self.gl_layer4 = BasicConv2d(_set_channels[2], _set_channels[2], 3, padding=1)
