...
parser.add_argument('--input_path', default='/home1/wxh/dataset/silhouette_normalization', type=str,
                    help='Root path of raw dataset.')
parser.add_argument('--output_path', default='/home1/lrj/moo/dataset/GaitSet_dataset', type=str,
